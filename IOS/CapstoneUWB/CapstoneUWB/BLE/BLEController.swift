...
struct TransferService {
    static let serviceUUID = CBUUID(string: "741F9B27-BDB7-41BC-B5D0-4BC4B79B5526")
    static let rxCharacteristicUUID = CBUUID(string: "741F9B27-BDB7-41BC-B5D0-4BC4B79B5526")
    static let txCharacteristicUUID = CBUUID(string: "741F9B27-BDB7-41BC-B5D0-4BC4B79B5526")
}
...
class DataCommunicationChannel: NSObject{
    ...
    func sendData(_ data: Data) throws{
        if discoveredPeripheral == nil {
            throw BLECentralError.noPeripherral
        }
        writeData(data)
    }
